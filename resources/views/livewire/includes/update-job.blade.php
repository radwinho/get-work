    ...
    <div class="w-11/12 md:w-1/2 mx-auto shadow rounded bg-white dark:bg-slate-800 p-8">
        <form class="relative">
            <div class="absolute -top-4 -right-4">
                <svg x-on:click='updateFrom = false' xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
            ...
            <div class="mb-6 border-b border-slate-300 dark:border-slate-50 pb-3">
                <h1 class="text-xl dark:text-white font-bold">Update Job</h1>
            </div>
            <div class="mb-6">
                <label for="name" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Job
                    name</label>
                <input wire:model='updateForm.name' type="text" id="name" autocomplete="no"
            ...
            <div class="mb-6">
                <label for="location" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Job
                    location</label>
                <input wire:model='updateForm.location' type="text" id="location" autocomplete="no"
                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                    >

                @error('updateForm.location')
                    <span class="mt-1 text-sm text-red-500">{{ $message }}</span>
                @enderror
            </div>
            ...
            <div class="mb-6">
                ...
                <select name="type" id="type" wire:model='updateForm.type'
                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                    required>
            ...
            <div x-data="{ tags: @entangle('updateForm.tags'), newTag: '', inputName: '' }">
                ...
                <button type="button" x-on:click="$wire.edit(tags), tags = [] "
